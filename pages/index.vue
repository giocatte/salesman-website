<template>
    <div>
      ...
      <div
        v-show="!isReady"
        class="w-full h-[calc(100vh_-_8rem)] flex items-center justify-center bg-white"
      >
        <div class="w-1/2">
      ...
      <div
        id="Home"
        v-show="isReady"
        class="w-full relative bg-white text-black"
      >
        <!-- ------------------ MOBILE LANDING -------------------------->
        <div
          v-if="isMobile"
        ...
        >
          ...
          <div id="imgsBCK" class="absolute inset-0 flex">
            <img
              src="assets/img/Polin_FornoPane.png"
              alt="Polin Forno per Pane"
              loading="lazy"
              draggable="false"
              class="w-1/2 h-full brightness-75 object-cover"
            />
            <img
              src="assets/img/Abbattitore_Polin.jpg"
              alt="Polin Abbattitore"
              loading="lazy"
              draggable="false"
              class="w-1/2 h-full brightness-75 object-cover"
            />
          ...
          <div
            id="Ellipse"
            class="absolute inset-0 py-24 bg-ellipse z-10"
          />
  
          <!-- testi -->
          <div
            id="NomeCognome"
            class="w-full z-20 py-14 px-2.5 flex flex-col gap-y-8
        ...
        <div v-else id="HomeDesktop">
          <div
            id="landingDesktop"
            class="relative grid grid-cols-2 w-full bg-iron text-gr font-nunito"
          >
            <!-- blocco testi -->
            <div
              id="NomeCognomeDesktop"
              class="py-24
                     px-6 lg:px-Tablet xl:pl-44 xl:pr-0
                     flex flex-col gap-y-7"
            >
              <p
                class="font-bold leading-[1.14]
            ...
            <div
              id="imgBCKDesktop"
              class="col-start-2 flex items-center justify-start
                     py-10 pr-12 lg:pr-Tablet xl:pr-24"
            >
              <img
                src="/img/DESKTOP/IMMAGINI_INIZIALI_DESKTOP/HOME.png"
                alt="Immagine di sfondo"
                loading="lazy"
                draggable="false"
                class="drop-shadow-[0_36px_50px_rgba(0,0,0,0.25)]"
              />
            </div>
          </div>
        </div>
        ...
        <div
        id="ChiSono_"
        class="relative w-full font-nunito bg-iron-op
        ...
        <div
          v-if="loghi"
          id="OnlyTheBest"
          class="relative py-8 lg:py-Tablet xl:py-Desktop"
        >
          <p
            class="text-[2rem] text-center font-extrabold font-nunito text-gr
