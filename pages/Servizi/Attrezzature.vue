    ...
    <div v-if="!isDesktop">
      ...
      <div class="bg-white pt-8 text-gr font-nunito flex flex-col gap-y-3 items-center">
        ...
        <div class="w-full pb-4 px-6 flex justify-between">
          ...
          <NuxtLink to="/Servizi/Peogettazione" class="p-1 w-[47%] rounded-full bg-BlueToRed">
...
useSeoMeta({
  title: 'Attrezzature e macchine per panifici, pasticcerie, pizzerie, gelaterie a Padova e Venezia',
  ogTitle: 'Attrezzature e macchine per panifici, pasticcerie, pizzerie, gelaterie a Padova e Venezia',
  description: 'Attrezzature e macchinari come Lavastoviglie, banco da lavoro, congelatore, refrigerate, abbattitori, teglie, carrelli. Consulenza, vendita e assistenza in Veneto, Padova e Venezia.',
  ogDescription: 'Attrezzature e Macchinari come Lavastoviglie, banco da lavoro, congelatore, refrigerate, abbattitori, teglie, carrelli. Consulenza, vendita e assistenza in Veneto, Padova e Venezia.',
