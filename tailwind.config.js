  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'BlueToRed':'linear-gradient(336deg, rgba(255, 0, 0, 0.5) 0%, rgba(255, 87, 0, 0.5) 22%, rgba(255, 136, 74, 0.5) 50%, rgba(53, 192, 255, 0.5) 51%, rgba(0, 123, 255, 0.5) 82%, rgba(0, 26, 255, 0.5) 100%)',
      },
    },
  },
  plugins: [
